...
class NotificationCards extends React.Component {
    ...
    async componentDidMount () {
        ...
        let temp = await axios.get(axios.fixUrl('/notifications'));
        this.setState({
            ...this.state,
            values: temp.data._embedded.notifications,
            newValue: {
                'userId': '',
                'msg': '',
                'sentDate': '2023-03-22',
        ...
        return (
            <div>
                <Stack
                    ...
                    spacing={2}
                >
                    <h1 style={titleStyle}>Notification</h1>
                    ...
                    >
                        <Grid container>
                            <Grid item xs>
                                {<Notification offline={this.state.offline} isNew={true} editMode={this.state.editMode} value={this.state.newValue} onChange={this.handleChange}
                        ...
                        {this.state.values.map((value,index) => {
                            return (
                                <Grid item xs={4} key={index}>
                                    <Notification offline={this.state.offline} keyIndex={index} onChange={this.handleListChange.bind(this, index)} editMode={value.editMode}
