    ...
    save = async() =>{
        try {
            ...
            if(!this.props.offline) {
                if(this.props.isNew) {
                    temp = await axios.post(axios.fixUrl('/drives'), this.props.value);
            ...
            <React.Fragment>
                <CardHeader
                    title={
                        ...
                        <Typography variant="h5" component="div">
                            Drive # {this.props.value._links.self.href.split("/")[this.props.value._links.self.href.split("/").length - 1]}
                        </Typography>:
                        <Typography variant="h5" component="div">
                            Drive
                        </Typography>
                ...
                <CardContent className="aggre-gate-root-card-content-style">
                    <Typography className="aggre-gate-root-typography-style" color="text.secondary">
                        ...
                        <String name="fileType" label="fileType" onChange={this.props.onChange} value={this.props.value.fileType?this.props.value.fileType:""} editMode={this.props.editMode}/>
                        <Number name="userId" label="userId" onChange={this.props.onChange} value={this.props.value.userId?this.props.value.userId:""} editMode={this.props.editMode}/>
                        <Date name="uploadedDate" label="uploadedDate" onChange={this.props.onChange} value={this.props.value.uploadedDate?this.props.value.uploadedDate:""} editMode={this.props.editMode}/>
                        <String name="state" label="state" onChange={this.props.onChange} value={this.props.value.state?this.props.value.state:""} editMode={this.props.editMode}/>
                        <Number name="fileSize" label="fileSize" onChange={this.props.onChange} value={this.props.value.fileSize?this.props.value.fileSize:""} editMode={this.props.editMode}/>
                    </Typography>
                </CardContent>
                <CardActions>
