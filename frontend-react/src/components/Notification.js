    ...
    save = async() =>{
        try {
            ...
            if(!this.props.offline) {
                if(this.props.isNew) {
                    temp = await axios.post(axios.fixUrl('/notifications'), this.props.value);
            ...
            <React.Fragment>
                <CardHeader
                    title={
                        ...
                        <Typography variant="h5" component="div">
                            Notification # {this.props.value._links.self.href.split("/")[this.props.value._links.self.href.split("/").length - 1]}
                        </Typography>:
                        <Typography variant="h5" component="div">
                            Notification
                        </Typography>
                ...
                <CardContent className="aggre-gate-root-card-content-style">
                    <Typography className="aggre-gate-root-typography-style" color="text.secondary">
                        ...
                        <String name="msg" label="msg" onChange={this.props.onChange} value={this.props.value.msg?this.props.value.msg:""} editMode={this.props.editMode}/>
                        <Date name="sentDate" label="sentDate" onChange={this.props.onChange} value={this.props.value.sentDate?this.props.value.sentDate:""} editMode={this.props.editMode}/>
                    </Typography>
                </CardContent>
                <CardActions>
