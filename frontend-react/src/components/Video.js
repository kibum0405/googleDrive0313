    ...
    save = async() =>{
        try {
            ...
            if(!this.props.offline) {
                if(this.props.isNew) {
                    temp = await axios.post(axios.fixUrl('/videos'), this.props.value);
            ...
            <React.Fragment>
                <CardHeader
                    title={
                        ...
                        <Typography variant="h5" component="div">
                            Video # {this.props.value._links.self.href.split("/")[this.props.value._links.self.href.split("/").length - 1]}
                        </Typography>:
                        <Typography variant="h5" component="div">
                            Video
                        </Typography>
                ...
                <CardContent className="aggre-gate-root-card-content-style">
                    <Typography className="aggre-gate-root-typography-style" color="text.secondary">
                        ...
                        <String name="videoUrl" label="videoUrl" onChange={this.props.onChange} value={this.props.value.videoUrl?this.props.value.videoUrl:""} editMode={this.props.editMode}/>
                        ...
                        <Date name="processedDate" label="processedDate" onChange={this.props.onChange} value={this.props.value.processedDate?this.props.value.processedDate:""} editMode={this.props.editMode}/>
                    </Typography>
                </CardContent>
                <CardActions>
